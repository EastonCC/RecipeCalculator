...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return { formatDate, deleteIngredient }
  },
  template: `
    <div class="view">
      ...
      <div class="card-grid" v-else>
        <div class="card" v-for="ing in store.ingredients" :key="ing.name">
          <div class="card-header">
            ...
            <div class="card-actions">
              ...
              <button class="btn btn-sm btn-danger" @click="deleteIngredient(ing.name)">Delete</button>
            </div>
          </div>
          <div class="card-body">
            <p class="price-line">
