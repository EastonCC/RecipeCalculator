            ...
            <table class="data-table">
              ...
              <tbody>
                <tr v-for="ri in recipe.ingredients" :key="ri.ingredientName">
                  ...
                  <td>
                    <span v-if="resolveIngredient(ri.ingredientName)" class="muted">
                      ${{ (() => {
                        const ing = resolveIngredient(ri.ingredientName)
                        const { convertUnit } = { convertUnit: (a,f,t) => {
                          // inline for template — real calc is in calcRecipeStats
                          return null
                        }}
                        return '—'
                      })() }}
